// @(#)root/minuit2:$Id: MnFunctionCross2.cxx,v 1.3 2008/09/18 07:04:59 nberger Exp $
...
MnCross MnFunctionCross2::operator()(const std::vector<unsigned int>& par, const std::vector<double>& pmid,
...
//   double edmmax = 0.5*0.001*toler*fFCN.Up();
   ...
   double up = fFCN.Up();
   double tlf = tlr*up;
   double mgr_tlr = 200 * up;   // to be consistent with F77 version
   double tla = tlr;
