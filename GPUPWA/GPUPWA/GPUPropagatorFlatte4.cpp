#include "GPUPropagatorFlatte4.h"
#include <cassert>
#include <cmath>
#ifdef USECPU
...
GPUPropagatorFlatte4::GPUPropagatorFlatte4(char * name,
...
GPUPropagatorFlatte4::~GPUPropagatorFlatte4(void)
{
}


GPUDataStream<float2> * GPUPropagatorFlatte4::operator()(int index, int block){
	...
	kernelflatte4(mList->GetDeviceInterface(), mx2stream, mass, mass*mass, g1, m1a, m1b, g2, m2a, m2b, g3, m3a, m3b, g4, m4a, m4b, mstream[index][block]);
