/// \file GPUPropagatorA980.h
#ifndef GPUPROPAGATORA980_H_
#define GPUPROPAGATORA980_H_

#include "GPUBasicPropagator.h"
#include "GPUPropagatorDerivative.h"
#include "ResCfg.h"

/// Implementation of a A980 Propagator

class GPUPropagatorA980 :
	public GPUBasicPropagator, public GPUPropagatorDerivative
{
public:
	/// Constructor
	GPUPropagatorA980(char * name,  ///< name of the propagator
	...
	/// Destructor
	virtual ~GPUPropagatorA980(void);
