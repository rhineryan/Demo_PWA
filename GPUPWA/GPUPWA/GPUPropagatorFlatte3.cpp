#include "GPUPropagatorFlatte3.h"
#include <cassert>
#include <cmath>
#ifdef USECPU
...
GPUPropagatorFlatte3::GPUPropagatorFlatte3(char * name,
                                           ...
                                           float _m3a,
                                           float _m3b):
		GPUBasicPropagator(name, _mx2, std::vector<char**>(4,(char **)0), 4),m1a(_m1a),m1b(_m1b),m2a(_m2a),m2b(_m2b),m3a(_m3a),m3b(_m3b){
...
GPUPropagatorFlatte3::~GPUPropagatorFlatte3(void)
{
}


GPUDataStream<float2> * GPUPropagatorFlatte3::operator()(int index, int block){
	...
	kernelflatte3(mList->GetDeviceInterface(), mx2stream, mass, mass*mass, g1, m1a, m1b, g2, m2a, m2b, g3, m3a, m3b, mstream[index][block]);
