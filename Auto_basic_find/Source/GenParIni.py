...
for line in f1:
  ...
  if line.find('yes')!=-1:
	...
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'>_'+str(num)+'_phase',0,1,-6.3,6.3))
      ...
      if fix==0:
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+'1'+'_mag',0, 1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+'1'+'_phase',0, 1,-6.3,6.3))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+'1'+'_mag',0, 1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+'1'+'_phase',0, 1,-6.3,6.3))

      if fix==1:
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+'1'+'_mag',25,-1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+'1'+'_phase',0,-1,-6.3,6.3))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+'1'+'_mag',25, 1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+'1'+'_phase',0, 1,-6.3,6.3))
	fix=0

      for num in range(2,5):
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+str(num)+'_mag',0, 1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_b>_'+str(num)+'_phase',0, 1,-6.3,6.3))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+str(num)+'_mag',0, 1,-500,500))
	f2.write("%-30s=%30.3f%30.3f%20.1f%20.1f\n"%('<'+arr[1]+'_'+arr[2]+'|'+arr[0]+'_c>_'+str(num)+'_phase',0, 1,-6.3,6.3))
      f2.write('\n')
